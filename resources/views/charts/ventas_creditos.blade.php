@extends('layouts.app')
@section('title', 'Reporte de ventas y creditos')
                ...
                <div class="form">
                    <form id="formFiltrarVentasCreditos" name="formFiltrarVentasCreditos" method="GET">
                        ...
                        <?php if (isset($_GET['fechaIni']) and isset($_GET['fechaFin'])){ ?>
                            <div class="col-sm-1">
                                <label></label><br>
                                <a href="{{ url('/reportes/ventas_creditos') }}"  data-toggle="tooltip" title="Quitar Filtro" class="btn btn-danger"><i class="ti-close"></i></a>
                            </div>
