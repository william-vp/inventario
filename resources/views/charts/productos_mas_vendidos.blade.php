@extends('layouts.app')
@section('title', 'Reporte de productos más vendidos')
                ...
                <div class="form">
                    <form id="formFiltrarProductos" name="formFiltrarProductos" method="GET">
                        ...
                        <?php if (isset($_GET['fechaIni']) and isset($_GET['fechaFin'])){ ?>
                            <div class="col-sm-1">
                                <label></label><br>
                                <a href="{{ url('/reportes/productos_mas_vendidos') }}"  data-toggle="tooltip" title="Quitar Filtro" class="btn btn-danger"><i class="ti-close"></i></a>
                            </div>
                            <div class="col-sm-3">
