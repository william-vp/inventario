    ...
    <div class="col-xs-12 col-lg-6 col-sm-12">
    	<h3 class="text-center">Datos Credito</h3>
    		<div class="list-group">
                ...
                <a href="#" class="list-group-item list-group-item-action"><strong>Id Cliente:</strong> {{$credito->cliente_id}}</a>
                <a href="#" class="list-group-item list-group-item-action"><strong>Nombre:</strong> {{$credito->nombre}}</a>

                @if ($credito->estado == 1)
                	<a href="#" class="list-group-item list-group-item-action"><strong>Estado:</strong> <span class="badge badge-success" style="font-size: 13px;"> PAGADO</span></a>
                @else
                	<a href="#" class="list-group-item list-group-item-action"><strong>Estado:</strong> <span class="badge badge-warning text-white" style="font-size: 13px;"> ACTIVO</span></a>
                @endif

                <a href="#" class="list-group-item list-group-item-action"><strong>Obervaciones:</strong> <p>{{$credito->observacion}}</p></a>

                <a href="{{ route('creditos.detalles', $credito->id) }}" class="list-group-item list-group-item-action bg-info text-center text-white rounded-0 font-weight-bold btnClose"><i class="fa fa-list"></i> VER MÁS DETALLES</a>
    ...
    <div class="col-xs-12 col-lg-6 col-sm-12">
            ...
            <form id="formAbono" name="formAbono" method="post"><br>
                ...
                <div class="form-group text-center">
                    <button type="button" class="btn btn-success btnAbono"><i class="ti-save"></i> INGRESAR ABONO</button>
                </div>
            </form>
            </div>
