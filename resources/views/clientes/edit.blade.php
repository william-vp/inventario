                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control"  data-toggle="tooltip" title="Recomendable No cambiar el id del cliente." placeholder="Id Cliente" name="id" id="id_edit" value="{{$cliente->id}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="Nombre Cliente" name="nombre" id="nombre_edit" value="{{$cliente->nombre}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-group">
                                                <input type="text" class="form-control" placeholder="Correo Electrónico" name="direccion" id="direccion_edit" value="{{$cliente->direccion}}">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                <input type="tel" class="form-control" placeholder="Telefono" name="telefono" id="telefono_edit" value="{{$cliente->telefono}}">
                                            </div>
                                        </div>
