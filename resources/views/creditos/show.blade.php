...
@section('content')
    ...
    <h4 class="text-primary mB-20 text-center">INFORMACIÓN CREDITO {{ $credito->id }}</h4>
                ...
                <div class="col-md-12 col-sm-12">
                    <form method="post" name="save_sale" id="save_sale">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            ...
                                            <div class="input-group">
                                                <input type="text" disabled class="form-control" value="{{ $credito->cliente_id }}">
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2 divNoCredito">
                                         ...
                                         @if ($credito->estado == 1)
                                         <div class="col-md-2">
                                         	<label>Ver Factura</label>
	                                         <a target="_new" class="btn btn-outline-success" href="{{ route('factura.view', $credito->factura_id) }}"><i class="ti-eye"></i> Ver Factura</a>
	                                     </div>
                                         @endif
                        ...
                        <h3 class="box-title text-center text-info">ABONOS
                        	@if ($credito->estado == 0)
                         	<a class="btn btn-outline-info pull-right" href="{{ route('creditos.abono', $credito->id) }}"><i class="ti-money"></i> Realizar Abono</a>
                         	@endif
                         </h3>
